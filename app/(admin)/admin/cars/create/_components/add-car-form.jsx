  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-indigo-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <TabsList className="grid w-full max-w-md mx-auto grid-cols-2 p-0 bg-white rounded-lg shadow-md">
            <TabsTrigger
              value="manual"
              className="data-[state=active]:bg-blue-100 data-[state=active]:text-blue-800 data-[state=active]:font-medium rounded-md transition-all"
            >
              Manual Entry
            </TabsTrigger>
            <TabsTrigger
            ...
            <Card className="bg-white/90 backdrop-blur-sm shadow-xl border-0 rounded-xl overflow-hidden">
              <CardHeader className="space-y-1 pb-4 border-b">
                ...
                <CardDescription className="text-gray-600">
                  Enter the details of the car you want to add to your
                  inventory.
                </CardDescription>
              </CardHeader>
              <CardContent className="pt-6">
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                  ...
                  {/* Featured */}
                  <div className="flex items-start space-x-3 space-y-0 rounded-md border p-4 bg-blue-50/50">
                    <Checkbox
                      id="featured"
                  ...
                  <div>
                    ...
                    <div className="mt-2">
                      <div
                        ...
                        className={`border-2 border-dashed rounded-lg p-6 text-center cursor-pointer hover:bg-blue-50/30 transition ${
                  ...
                  <Button
                    type="submit"
                    className="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white font-medium py-2 px-6 rounded-md transition-colors"
          ...
          <TabsContent value="ai" className="mt-6">
            <Card className="bg-white/90 backdrop-blur-sm shadow-xl border-0 rounded-xl overflow-hidden">
              <CardHeader className="space-y-1 pb-4 border-b">
                <CardTitle className="text-2xl font-bold text-gray-900">
                  AI-Powered Car Details
                </CardTitle>
                <CardDescription className="text-gray-600">
                  Let our AI analyze your car images and extract details
                  automatically.
                </CardDescription>
              </CardHeader>
              ...
              <CardContent className="pt-6">
                <div className="space-y-6">
                  <div className="border-2 border-dashed rounded-xl p-8 bg-white/50 backdrop-blur-sm transition-all hover:border-blue-400 hover:bg-blue-50/30">
                    {imagePreview ? (
                      <div className="flex flex-col items-center">
                        <img
                          src={imagePreview}
                          alt="Car preview"
                          className="max-h-56 max-w-full object-contain mb-4 rounded-md shadow-sm"
                        />
                      ...
                      <div
                        {...getAiRootProps()}
                        className="cursor-pointer hover:bg-blue-50/30 transition"
                      >
                  ...
                  {processImageLoading && (
                    <div className="bg-blue-50 text-blue-700 p-4 rounded-md flex items-center shadow-sm">
